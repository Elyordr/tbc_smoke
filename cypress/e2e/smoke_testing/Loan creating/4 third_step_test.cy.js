...
describe('Third step', function () {
  ...
  it('Клиент отказался', function () {
    ...
    cy.intercept('GET', 'https://test-api-agent.tbcfin.uz/v1/get-all-loans?limit=10&page=1').as('get-loans')
    cy.wait('@get-loans', {timeout: 25000})
  ...
  it('Back button in the third step', function () {
    ...
    cy.get('input[name="phone_number_1"]').should('be.disabled')
